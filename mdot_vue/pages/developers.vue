      ...
      <div class="row mb-5">
        ...
        <div class="col-md-4">
          ...
          <ul>
            <li>
              <a
                title="UX Magazine: The Experience Makes the Product, Not the Features"
                href="https://uxmag.com/articles/the-experience-makes-the-product-not-the-features"
                >Understand Minimum Viable Product (MVP)</a
              >
            </li>
            <li>
              <a
                title="Brad Frost: Mobile First Responsive Web Design"
                href="http://bradfrost.com/blog/web/mobile-first-responsive-web-design/"
                >Mobile-First Responsive Approach</a
              >
            </li>
            <li>
              <a
                title="Intercom Blog: Product Strategy Means Saying No"
                href="https://blog.intercom.io/product-strategy-means-saying-no/"
                >Product Strategy Means Saying No</a
              >
            </li>
          </ul>
        </div>
        <div class="col-md-4 article">
          ...
          <p>
            Build a solid foundation, put it in front of users, and then
            optimize through iteration.
          </p>
          <ul>
            <li>
              <a
                title="Intercom Blog: Start With a Cupcake"
                href="https://blog.intercom.io/start-with-a-cupcake/"
                >Start With a Cupcake</a
              >
            </li>
            <li>
              <a
                title="Intercom Blog: Ways to Improve A Product"
                href="https://blog.intercom.io/ways-to-improve-a-product/"
                >Ways to Improve A Product</a
              >
            </li>
          </ul>
        </div>
      ...
      <div class="row mb-5">
        <div class="col-md-4">
          ...
          <p>
            ...
            Understand your various options.
          </p>
          <ul>
            <li>
              <a
                title="Smashing Magazine: Four Ways To Build a Mobile Application"
                href="http://www.smashingmagazine.com/2013/11/four-ways-to-build-a-mobile-app-part1-native-ios/"
                >Four Ways To Build a Mobile Application</a
              >
            </li>
            <li>
              <a
                title="Salesforce Developers: Understanding Your Mobile Application Development Options"
                href="https://developer.salesforce.com/page/Native,_HTML5,_or_Hybrid:_Understanding_Your_Mobile_Application_Development_Options"
                >Understanding Development Options</a
              >
            </li>
          </ul>
        </div>
        <div class="col-md-4">
          ...
          <ul>
            <li>
              <a
                title="Ionic: Create amazing apps"
        ...
        <div class="col-md-4">
          ...
          <ul>
            <li>
              <a
                title="Varvy Blog: Critical Rendering Path Explained"
                href="https://www.feedthebot.com/pagespeed/critical-render-path.html"
                >What is the critical rendering path?</a
              >
            </li>
            <li>
              <a
                title="Google Developers: Critical Rendering Path"
                href="https://developers.google.com/web/fundamentals/performance/critical-rendering-path/index?hl=en"
                >Optimizing the Critical Rendering Path</a
              >
            </li>
            <li>
              <a
                title="Ilya Grigorik: Optimizing the Critical Renderign Path for Instant Mobile Websites [video]"
                href="https://www.youtube.com/watch?v=YV1nKLWoARQ"
                >Optimization for Mobile Websites [Video]
              </a>
            </li>
          </ul>
        </div>
      ...
      <div class="row mb-5">
        <div class="col-md-4">
          ...
          <ul>
            <li>
              <a
                title="Enrolling in developer program and managing developer account (iOS)"
            ...
            <li>
              <a
                title="Signing your applications (iOS)"
            ...
            <li>
              <a
                title="Design guidelines (iOS)"
                href="https://developer.apple.com/library/ios/documentation/UserExperience/Conceptual/MobileHIG/"
                >Design Guidelines</a
              >
            </li>
          </ul>
        ...
        <div class="col-md-4">
          ...
          <ul>
            <li>
              <a
                title="Get started with publishing (Android)"
                href="http://developer.android.com/distribute/googleplay/start.html"
                >Getting Started
              </a>
            </li>
            <li>
              <a
                title="Signing your applications (Android)"
            ...
            <li>
              <a
                title="Upload and distribute apps (Android)"
                href="https://support.google.com/googleplay/android-developer/answer/113469?hl=en&ref_topic=3450986"
                >App Distribution</a
              >
            </li>
            <li>
